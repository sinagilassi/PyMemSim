...
# ! locals
from examples.source.gas_load_model_source import O2, N2, model_source
...
feed_mole_fractions = {
    "O2-g": CustomProp(value=0.205, unit=""),
    "N2-g": CustomProp(value=0.795, unit=""),
}

# feed inlet temperature
feed_inlet_temperature = Temperature(value=296.15, unit="K")

# feed inlet pressure
feed_pressure = CustomProp(value=690, unit="kPa")

# permeate inlet temperature
permeate_inlet_temperature = Temperature(value=296.15, unit="K")

# permeate inlet pressure
permeate_pressure = CustomProp(value=100, unit="kPa")

# NOTE: gas transport coefficients Pi_i (Permeance) for each component i
# ! gpu
gas_transport_coefficients = {
    "O2-g": CustomProp(value=9.30, unit="GPU"),
    "N2-g": CustomProp(value=1.80, unit="GPU"),
}
...
module_geometry = HollowFiberMembraneModuleGeometry(
    ...
    module_diameter=CustomProp(value=0.95, unit="cm"),
)
